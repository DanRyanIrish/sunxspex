...
class ChiantiThermalSpectrum():
    ...
    """
    @u.quantity_input(observer_distance='length')
    ...
    def chianti_kev_lines(self, energy_edges, temperature, emission_measure=1e44/u.cm**3, relative_abundances=None, **kwargs):
        """
